 ...
 *
 * @version $Id: yii.php 2874 2011-01-16 14:55:27Z qiang.xue $
 */
return array (
  ...
  'Unable to remove migration {class}.' => 'Migration {class} konnte nicht entfernt werden.',
  ...
  'Unable to import "{alias}". Please check your server configuration to make sure you are allowed to change PHP include_path.' => 'Konnte Alias "{alias}" nicht importieren. Bitten prüfen Sie Ihre Serverkonfiguration um sicherzustellen, dass sie PHP include_path verändern dürfen.',
